...
export namespace crypto {
    class BN {
      constructor(number: number | string | Buffer | Uint8Array, base?: number, endian?: string);
    }
    ...
    namespace Schnorr {
        function sign(key: PrivateKey, message: Buffer): Buffer;
    }
...
export namespace Transaction {
    ...
    class Input {
        ...
        toBufferWriter(writer: encoding.BufferWriter): void;
    ...
    interface ExecData {
      ...
      annexInit: boolean
      tapleafHash: Buffer
      tapleafHashInit: boolean
      codeseparatorPos: crypto.BN
...
export namespace encoding {
  class BufferWriter {
    ...
    constructor();
    toBuffer(): Buffer;
    writeVarintNum(num: number): void;
